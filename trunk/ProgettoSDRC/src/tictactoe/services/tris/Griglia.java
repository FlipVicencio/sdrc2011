...
implements org.apache.axis2.databinding.ADBBean{
	...
	protected tictactoe.services.tris.GrigliaType localGriglia ;


	/**
	 * Auto generated getter method
	 * @return tictactoe.services.tris.GrigliaType
	 */
	public  tictactoe.services.tris.GrigliaType getGriglia(){
		return localGriglia;
	}
	 ...
	 * @param param Griglia
	 */
	public void setGriglia(tictactoe.services.tris.GrigliaType param){
				...
				while(!reader.isEndElement()) {
					if (reader.isStartElement() ){
						...
						if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.dsi.unifi.it/Tris/","griglia").equals(reader.getName())){
							...
							object.setGriglia(tictactoe.services.tris.GrigliaType.Factory.parse(reader));
