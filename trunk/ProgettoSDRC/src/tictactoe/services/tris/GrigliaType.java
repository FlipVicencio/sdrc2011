...
/**
 *  GrigliaType bean class
 */


public  class GrigliaType
implements org.apache.axis2.databinding.ADBBean{
	...
	protected tictactoe.services.tris.CellaType localCella11 ;


	/**
	 * Auto generated getter method
	 * @return tictactoe.services.tris.CellaType
	 */
	public  tictactoe.services.tris.CellaType getCella11(){
		return localCella11;
	}
	 ...
	 * @param param Cella11
	 */
	public void setCella11(tictactoe.services.tris.CellaType param){
	...
	protected tictactoe.services.tris.CellaType localCella12 ;
	 ...
	 * @return tictactoe.services.tris.CellaType
	 */
	public  tictactoe.services.tris.CellaType getCella12(){
		return localCella12;
	}
	 ...
	 * @param param Cella12
	 */
	public void setCella12(tictactoe.services.tris.CellaType param){
	...
	protected tictactoe.services.tris.CellaType localCella13 ;
	 ...
	 * @return tictactoe.services.tris.CellaType
	 */
	public  tictactoe.services.tris.CellaType getCella13(){
		return localCella13;
	}
	 ...
	 * @param param Cella13
	 */
	public void setCella13(tictactoe.services.tris.CellaType param){
	...
	protected tictactoe.services.tris.CellaType localCella21 ;
	 ...
	 * @return tictactoe.services.tris.CellaType
	 */
	public  tictactoe.services.tris.CellaType getCella21(){
		return localCella21;
	}
	 ...
	 * @param param Cella21
	 */
	public void setCella21(tictactoe.services.tris.CellaType param){
	...
	protected tictactoe.services.tris.CellaType localCella22 ;
	 ...
	 * @return tictactoe.services.tris.CellaType
	 */
	public  tictactoe.services.tris.CellaType getCella22(){
		return localCella22;
	}
	 ...
	 * @param param Cella22
	 */
	public void setCella22(tictactoe.services.tris.CellaType param){
	...
	protected tictactoe.services.tris.CellaType localCella23 ;
	 ...
	 * @return tictactoe.services.tris.CellaType
	 */
	public  tictactoe.services.tris.CellaType getCella23(){
		return localCella23;
	}
	 ...
	 * @param param Cella23
	 */
	public void setCella23(tictactoe.services.tris.CellaType param){
	...
	protected tictactoe.services.tris.CellaType localCella31 ;
	 ...
	 * @return tictactoe.services.tris.CellaType
	 */
	public  tictactoe.services.tris.CellaType getCella31(){
		return localCella31;
	}
	 ...
	 * @param param Cella31
	 */
	public void setCella31(tictactoe.services.tris.CellaType param){
	...
	protected tictactoe.services.tris.CellaType localCella32 ;
	 ...
	 * @return tictactoe.services.tris.CellaType
	 */
	public  tictactoe.services.tris.CellaType getCella32(){
		return localCella32;
	}
	 ...
	 * @param param Cella32
	 */
	public void setCella32(tictactoe.services.tris.CellaType param){
	...
	protected tictactoe.services.tris.CellaType localCella33 ;
	 ...
	 * @return tictactoe.services.tris.CellaType
	 */
	public  tictactoe.services.tris.CellaType getCella33(){
		return localCella33;
	}
	 ...
	 * @param param Cella33
	 */
	public void setCella33(tictactoe.services.tris.CellaType param){
	...
	protected tictactoe.services.tris.StatusType localStatus ;


	/**
	 * Auto generated getter method
	 * @return tictactoe.services.tris.StatusType
	 */
	public  tictactoe.services.tris.StatusType getStatus(){
		return localStatus;
	}
	 ...
	 * @param param Status
	 */
	public void setStatus(tictactoe.services.tris.StatusType param){
		...
		public static GrigliaType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
					...
					if (fullTypeName!=null){
						...
						if (!"grigliaType".equals(type)){
							...
							return (GrigliaType)tictactoe.services.tris.ExtensionMapper.getTypeObject(
									nsUri,type,reader);
						}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("","cella11").equals(reader.getName())){
					...
					object.setCella11(tictactoe.services.tris.CellaType.Factory.parse(reader));
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("","cella12").equals(reader.getName())){
					...
					object.setCella12(tictactoe.services.tris.CellaType.Factory.parse(reader));
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("","cella13").equals(reader.getName())){
					...
					object.setCella13(tictactoe.services.tris.CellaType.Factory.parse(reader));
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("","cella21").equals(reader.getName())){
					...
					object.setCella21(tictactoe.services.tris.CellaType.Factory.parse(reader));
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("","cella22").equals(reader.getName())){
					...
					object.setCella22(tictactoe.services.tris.CellaType.Factory.parse(reader));
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("","cella23").equals(reader.getName())){
					...
					object.setCella23(tictactoe.services.tris.CellaType.Factory.parse(reader));
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("","cella31").equals(reader.getName())){
					...
					object.setCella31(tictactoe.services.tris.CellaType.Factory.parse(reader));
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("","cella32").equals(reader.getName())){
					...
					object.setCella32(tictactoe.services.tris.CellaType.Factory.parse(reader));
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("","cella33").equals(reader.getName())){
					...
					object.setCella33(tictactoe.services.tris.CellaType.Factory.parse(reader));
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("","status").equals(reader.getName())){
					...
					object.setStatus(tictactoe.services.tris.StatusType.Factory.parse(reader));
